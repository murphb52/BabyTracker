# 044 Onboarding Intro Refresh First Pass

## Summary

Refresh the onboarding intro pages so the opening experience feels more alive without changing the overall flow or layout structure.

This first pass will keep the existing pager and name step, but replace the intro copy with clearer, more concrete messaging for new parents and introduce richer SF Symbol animation on each page.
...
5. Verify the affected feature package still builds and that previews remain useful.

## Tracking

- GitHub issue: not created for this first-pass UI exploration
- Branch: `codex/refresh-onboarding-first-pass`
