...
`Claude.md` and `AGENTS.md` contain identical content. They exist side by side because different tools look for different filenames. If you update one, update the other to the same content. `AGENTS.md` is the source of truth; this file is a mirror.
